...
//(function (_, $, Backbone) {
(function (factory) { // ADDED - MetaIT
    if (typeof define === 'function' && define.amd) { // ADDED - MetaIT
        // AMD. Register as an anonymous module. // ADDED - MetaIT
        define(['underscore', 'jquery', 'backbone', 'backboneModelBinder'], factory); // ADDED - MetaIT
    } else { // ADDED - MetaIT
        // Browser globals // ADDED - MetaIT
        factory(_, $, Backbone); // ADDED - MetaIT
    } // ADDED - MetaIT
} // ADDED - MetaIT
(function(_, $, Backbone){
    if (!Backbone) {
