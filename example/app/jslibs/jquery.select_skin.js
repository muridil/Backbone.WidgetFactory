        ...
        $(this).each(function (i) {
            ...
            if (!s.attr('multiple')) {
                ...
                */
                ...
                c.children().before('<div class="cmf-skinned-pic"></div>');
            }
        });
    }

    $.fn.select_small_skin = function (w) {
        $(this).each(function (i) {
            s = $(this);
            if (!s.attr('multiple')) {
                // create the container
                s.wrap('<div class="cmf-skinned-select-small"></div>');
                c = s.parent();
                c.children().before('<div class="cmf-skinned-text-small">&nbsp;</div>').each(function () {
                    if (this.selectedIndex >= 0) $(this).prev().text(this.options[this.selectedIndex].innerHTML)
                });
                ...
                c.children().before('<div class="cmf-skinned-pic-small"></div>');
            }
        });
    }
    ...
    $.fn.select_unskin = function (w) {
        return $(this).each(function (i) {
            ...
            if (!s.attr('multiple') && s.parent().hasClass('cmf-skinned-select')) {
                ...
                s.siblings('.cmf-skinned-pic').remove();
